...
class ChefTest < ActiveSupport::TestCase
  ...
  test "all associated recipes must be destroyed on deletion of chef" do
    @chef.save
    @recipe = @chef.recipes.create!(name: "Must be a destroyed recipe", description: "Must be destroyed.")
